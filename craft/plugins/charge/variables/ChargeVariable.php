...
class ChargeVariable
{
	...
	{
		return craft()->charge_payment->getPaymentById($paymentId);
	}

	public function getChargeById($chargeId)
	{
		return craft()->charge_charge->getChargeById($chargeId);
	}

	public function getSubscriberByChargeId($chargeId)
	{
		return craft()->charge_subscriber->getSubscriberByChargeId($chargeId);
	}
